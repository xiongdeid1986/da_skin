...
<table width="100%" cellspacing="0" cellpadding="0"><tr><td>{$LANG.show}: <a href="supporttickets.php?{if $searchterm}searchterm={$searchterm}&token={$token}&{/if}itemlimit=10">10</a> <a href="supporttickets.php?{if $searchterm}searchterm={$searchterm}&token={$token}&{/if}itemlimit=25">25</a> <a href="supporttickets.php?{if $searchterm}searchterm={$searchterm}&token={$token}&{/if}itemlimit=50">50</a> <a href="supporttickets.php?{if $searchterm}searchterm={$searchterm}&token={$token}&{/if}itemlimit=100">100</a> <a href="supporttickets.php?{if $searchterm}searchterm={$searchterm}&token={$token}&{/if}itemlimit=all">{$LANG.all}</a></td><td align="right">{if $prevpage}<a href="supporttickets.php?{if $searchterm}searchterm={$searchterm}&token={$token}&{/if}page={$prevpage}">{/if}&laquo; {$LANG.previouspage}{if $prevpage}</a>{/if} &nbsp; {if $nextpage}<a href="supporttickets.php?{if $searchterm}searchterm={$searchterm}&token={$token}&{/if}page={$nextpage}">{/if}{$LANG.nextpage} &raquo;{if $nextpage}</a>{/if}</td></tr></table>