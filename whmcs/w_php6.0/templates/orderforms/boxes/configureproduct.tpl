...
<tr class="orderheadingrow"><td colspan="2"></td></tr>
<tr class="orderrow1"><td class="leftcol">{$LANG.serverhostname}</td><td><input type="text" name="hostname" size="15" value="{$server.hostname}" /> {$LANG.serverhostnameexample}</td></tr>
<tr class="orderrow2"><td class="leftcol">{$LANG.serverns1prefix}</td><td><input type="text" name="ns1prefix" size="10" value="{$server.ns1prefix}" /> {$LANG.serverns1prefixexample}</td></tr>
<tr class="orderrow1"><td class="leftcol">{$LANG.serverns2prefix}</td><td><input type="text" name="ns2prefix" size="10" value="{$server.ns2prefix}" /> {$LANG.serverns2prefixexample}</td></tr>
