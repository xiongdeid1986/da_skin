  ...
  <table width="100%" cellspacing="0" cellpadding="0" class="frame">
    <tr>
      <td><table width="100%" border="0" cellpadding="10" cellspacing="0">
          ...
          <tr><td class="fieldarea">{$LANG.creditcardcardnumber}</td><td>{if $allowcustomerdelete && $cardtype}<form method="post" action="{$smarty.server.PHP_SELF}?action=creditcard">{/if}{$cardnum}{if $allowcustomerdelete && $cardtype} &nbsp;&nbsp;&nbsp; <input type="submit" name="remove" value="{$LANG.creditcarddelete}" class="button" /></form>{/if}</td></tr>
