...
class WHMCS_Init {
	...
	protected $protected_variables = array('whmcs', 'smtp_debug', 'attachments_dir', 'downloads_dir', 'customadminpath', 'mysqli_charset', 'overidephptimelimit', 'orderform', 'smartyvalues', 'usingsupportmodule', 'copyrighttext', 'adminorder', 'revokelocallicense', 'allow_idn_domains', 'templatefile', '_LANG', '_ADMINLANG', 'display_errors', 'debug_output', 'mysqli_errors', 'moduleparams', 'errormessage');
	/**
