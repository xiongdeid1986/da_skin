...
{
    $configarray = array( 'Username' => array( 'Type' => 'text', 'Size' => '25', 'Description' => "Don't have a GlobalSign SSL account? <a href=\"http://www.globalsign.com/partners/whmcs/\" target=\"_blank\">Click Here</a>" ), "SSL Certificate Type" => array( 'Type' => 'dropdown', 'Options' => 'DomainSSL,AlphaSSL' ), 'Password' => array( 'Type' => 'password', 'Size' => '25' ), "Validity Period" => array( 'Type' => 'dropdown', 'Options' => '1,2,3', 'Description' => 'Years' ), 'Coupon' => array( 'Type' => 'text', 'Size' => '25', 'Description' => "(Optional)" ), "Order Kind" => array( 'Type' => 'dropdown', 'Options' => 'New,Transfer,Renewal', 'Description' => "(Default)" ), 'Campaign' => array( 'Type' => 'text', 'Size' => '25', 'Description' => "(Optional)" ), "Test Mode" => array( 'Type' => 'yesno' ) );
...
{
    if( !mysqli_num_rows(full_query("SHOW TABLES LIKE 'mod_gsvouchers'")) )
    {
