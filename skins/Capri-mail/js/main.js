$(function(){
  ...
  $("#searchval1, #searchval8").focus(function(){$(this).val("");$(this).addClass("focus");});
  ...
  $(".randpass").click(function(){$("input[name='passwd'],input[name='passwd2']").val(randPass());$(".pster .box").removeClass("s0 s1 s2 s4 s5").addClass("s3");$(".pster").find("span").text("Medium");});
  ...
  $("input[name='passwd']").bind("keyup change",function(){var d=new Array();d[0]="Very Weak";d[1]="Very Weak";d[2]="Weak";d[3]="Medium";d[4]="Good";d[5]="Strong";var s=passwordStrength($(this).val());$(".pster .box").removeClass("s0 s1 s2 s3 s4 s5").addClass("s"+s);$(".pster").find("span").text(d[s]);});
});
...
function randPass(){chars="!_-.$#@abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890!_-.$#@";pass="";for(x=0;x<8;x++){i=Math.floor(Math.random()*76);pass += chars.charAt(i);};return pass;}
