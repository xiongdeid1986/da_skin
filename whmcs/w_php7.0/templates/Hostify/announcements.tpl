...
{foreach from=$announcements item=announcement}
    ...
    <div class="announcement-single">
        ...
        <a href="{routePath('announcement-view', $announcement.id, $announcement.urlfriendlytitle)}" class="title ybtn-purple-text">
            {$announcement.title}
        </a>

        <div class="article-items">
            <i class="fa fa-calendar"></i> {"Y-m-d"|date:$announcement.timestamp}
        </div>
        ...
        {else}
            ...
            <a href="{routePath('announcement-view', $announcement.id, $announcement.urlfriendlytitle)}" class="ybtn-purple ybtn-small">{$LANG.readmore} &raquo;</a>
        {/if}
