...
{if $invalidtld}
    <p align="center" class="textred" style="font-size:18px;">{$invalidtld|strtoupper} {$LANG.domaincheckerinvalidtld}</p>
{elseif $available}
...
{else}
<p align="center" class="textred" style="font-size:18px;">{$LANG.domainunavailable1} <strong>{$sld}{$ext}</strong> {$LANG.domainunavailable2}</p>
{/if}
