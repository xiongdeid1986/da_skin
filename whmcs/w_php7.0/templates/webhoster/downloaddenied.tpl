...
<p align="center"><input type="submit" value="Click Here to Renew &raquo;" class="btn btn-success btn-sm" /></p>
</form>
...
{/if}
<p align="center"><input type="submit" value="{$LANG.ordernowbutton} &raquo;" class="btn btn-sm btn-success" /></p>
</form>
{/if}
