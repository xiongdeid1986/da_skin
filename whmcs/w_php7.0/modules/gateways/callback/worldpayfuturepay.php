...
$invoiceid = mysqli_real_escape_string($GLOBALS['whmcsmysql'],$_POST['cartId']);
$futurepayid = mysqli_real_escape_string($GLOBALS['whmcsmysql'],$_POST['futurePayId']);
$transid = mysqli_real_escape_string($GLOBALS['whmcsmysql'],$_POST['transId']);
