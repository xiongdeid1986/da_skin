		...
		<div class="affiliate-referral-link text-center">
			<div class="main">	
				...
				<p style="text-align:center;margin-top:-40px;">
					<img src="./templates/{$template}/assets/img/link.png" style="width:55px;">
				</p>
				<div class="info">
		...
		<div class="affiliates">
		    ...
		    <div class="well">
			    <div aria-hidden="true" class="icon">
				    <img src="./templates/{$template}/assets/img/Street-View.svg" class="theme-grey size-md" />
			    </div>
			    <div class="main">
			...
			<div class="well">
		    	<div aria-hidden="true" class="icon">
				    <img src="./templates/{$template}/assets/img/Networking-1.svg" class="theme-grey size-md" />
			    </div>
				<div class="main">
		    ...
		    <div class="well">
		    	<div aria-hidden="true" class="icon">
				    <img src="./templates/{$template}/assets/img/Dot-Chart 1.svg" class="theme-grey size-md" />
			    </div>
				<div class="main">
		    ...
		    <div class="well">
		    	<div aria-hidden="true" class="icon">
				    <img src="./templates/{$template}/assets/img/Coin-and Cash.svg" class="theme-grey size-md" />
			    </div>
				<div class="main">
		    ...
		    <div class="well">
		    	<div aria-hidden="true" class="icon">
				    <img src="./templates/{$template}/assets/img/Cash-Payment.svg" class="theme-grey size-md" />
			    </div>
				<div class="main">
		    ...
		    <div class="well">
		    	<div aria-hidden="true" class="icon">
				    <img src="./templates/{$template}/assets/img/Money-Bag.svg" class="theme-grey size-md" />
			    </div>
				<div class="main">
