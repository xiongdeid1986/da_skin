...
<!-- Custom Styling -->
<link rel="stylesheet" href="./templates/{$template}/css/custom.css">
...
<link href="./templates/{$template}/assets/whmcs/css/idangerous.swiper.css" rel="stylesheet"/>
<link href="./templates/{$template}/assets/whmcs/css/whmcs.css" rel="stylesheet">
<link href="./templates/{$template}/assets/nrghosts/css/nrghost.css" rel="stylesheet" type="text/css" />

<link rel="shortcut icon" href="./templates/{$template}/assets/nrghosts/img/favicon.ico" />
