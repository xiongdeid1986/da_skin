...
if( $deptid )
{
    $filters[] = "did IN (" . mysqli_real_escape_string($GLOBALS['whmcsmysql'],$deptid) . ")";
}
if( $clientid )
{
    $filters[] = "userid='" . mysqli_real_escape_string($GLOBALS['whmcsmysql'],$clientid) . "'";
}
if( $email )
{
    $filters[] = "(email='" . mysqli_real_escape_string($GLOBALS['whmcsmysql'],$email) . "' OR userid=(SELECT id FROM tblclients WHERE email='" . mysqli_real_escape_string($GLOBALS['whmcsmysql'],$email) . "'))";
}
...
else
{
    ...
    else
    {
        ...
        else
        {
            if( $status )
            {
                $filters[] = "status='" . mysqli_real_escape_string($GLOBALS['whmcsmysql'],$status) . "'";
            }
        }
    }
}
if( $subject )
{
    $filters[] = "title LIKE '%" . mysqli_real_escape_string($GLOBALS['whmcsmysql'],$subject) . "%'";
}
