<?php /* Smarty version 2.6.28, created on 2017-08-10 16:51:29
         compiled from webhoster/clientareaaddcontact.tpl */ ?>
...
"><?php echo $this->_tpl_vars['contact']['name']; ?>
    ...
    </select> <input class="btn btn-purple btn-sm" type="submit" value="<?php echo $this->_tpl_vars['LANG']['go']; ?>
" />
	</div>
</form>

<form class="form-horizontal" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>
?action=addcontact" class="form-horizontal">
...
" />
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
		    <input type="text" class="col-xs-12 col-sm-4" name="phonenumber" id="phonenumber" value="<?php echo $this->_tpl_vars['contactphonenumber']; ?>
" />
		</div>
	</div>
...
<div id="subaccountfields" class="<?php if (! $this->_tpl_vars['subaccount']): ?> <?php endif; ?>" style="display: none;">
...
<fieldset>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
		    <input type="password" class="col-xs-12 col-sm-3" name="password" id="password" />
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
		    <input type="password" class="col-xs-12 col-sm-3" name="password2" id="password2" />
		</div>
	</div>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <div class="form-group">
	    <label class="col-sm-3 control-label"><?php echo $this->_tpl_vars['LANG']['subaccountpermissions']; ?>
</label>
			<div class="col-sm-9">
				<div class="tcb">
                    <label>
