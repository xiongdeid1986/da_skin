...
<table cellspacing="1" cellpadding="0" class="frame"><tr><td>
<table width="100%" cellpadding="2">
<tr class="newccinfo"{if $cardnum && $ccinfo neq "new"} style="display:none;"{/if}><td width="120" class="fieldarea">{$LANG.creditcardcardtype}</td><td><select name="cctype" id="cctype">
...
{/if}
<tr><td width="120" class="fieldarea">{$LANG.creditcardcvvnumber}</td><td><input type="text" name="cccvv" id="cccvv" size="5" value="{$cccvv}" autocomplete="off" /> <a href="#" onclick="window.open('images/ccv.gif','','width=280,height=200,scrollbars=no,top=100,left=100');return false">{$LANG.creditcardcvvwhere}</a></td></tr>
