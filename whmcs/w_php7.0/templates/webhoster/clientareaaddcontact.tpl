...
<select class="col-sm-2" name="contactid" onchange="submit()">
    ...
    </select> <input class="btn btn-purple btn-sm" type="submit" value="{$LANG.go}" />
	</div>
</form>

<form class="form-horizontal" method="post" action="{$smarty.server.PHP_SELF}?action=addcontact" class="form-horizontal">
...
<fieldset>
    ...
    <div class="form-group">
		...
		<div class="col-sm-9">
		    <input type="text" class="col-xs-12 col-sm-4" name="phonenumber" id="phonenumber" value="{$contactphonenumber}" />
		</div>
	</div>
...
<div id="subaccountfields" class="{if !$subaccount} {/if}" style="display: none;">
