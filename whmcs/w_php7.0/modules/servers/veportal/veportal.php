...
{
    if( !mysqli_num_rows(full_query("SHOW TABLES LIKE 'mod_veportal'")) )
    {
...
function veportal_updateCustomData($params, $veid, $ip, $hostname)
{
    ...
    full_query("UPDATE tblcustomfieldsvalues SET value='" . db_escape_string($veid) . "' WHERE fieldid='" . (int) $cfield['veid'] . "' AND relid = '" . (int) $params['serviceid'] . "'") or exit( mysqli_error($GLOBALS['whmcsmysql'], );
    full_query("UPDATE tblcustomfieldsvalues SET value='" . db_escape_string($hostname) . "' WHERE fieldid='" . (int) $cfield['hostname'] . "' AND relid = '" . (int) $params['serviceid'] . "'") or exit( mysqli_error($GLOBALS['whmcsmysql'], );
    full_query("UPDATE tblcustomfieldsvalues SET value='" . db_escape_string($ip) . "' WHERE fieldid='" . (int) $cfield['ipad'] . "' AND relid = '" . (int) $params['serviceid'] . "'") or exit( mysqli_error($GLOBALS['whmcsmysql'], );
}
function veportal_updateVPSinfo($veid, $ip, $hostname, $serviceid, $params)
{
    ...
    full_query("UPDATE tblhosting SET domain='" . db_escape_string($hostname) . "', dedicatedip='DO NOT EDIT THESE VALUES;veid=" . db_escape_string($veid . ";ip=" . $ip . ";hostname=" . $hostname) . "' WHERE id=" . (int) $serviceid) or exit( mysqli_error($GLOBALS['whmcsmysql'], );
