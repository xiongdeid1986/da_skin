...
function ventraip_getConfigArray()
{
    ...
    $check_config_exists = simulate_fetch_assoc(full_query("SELECT count(`id`) as `n` FROM `tblregistrars` WHERE `registrar` = '" . mysqli_real_escape_string($GLOBALS['whmcsmysql'],$moduleName[0]) . "'"));
