...
{
    public function TPPW_AuthAPI($params)
    {
...
class TPPW_QueryAPI extends TPPW_API
{
    ...
    public function TPPW_QueryAPI($params)
    {
...
{
    public function TPPW_ResourceAPI($params)
    {
...
{
    public function TPPW_OrderAPI($params)
    {
        parent::tppw_api("order.pl", $params);
    }
    private function saveWorkflowId($result)
    {
        if( $result->isSuccess() )
        {
...
class TPPW_APIResult
{
    ...
    public function TPPW_APIResult($response)
    {
...
function tppwregistrar_checkOrder($params)
{
    ...
    if( $result->isSuccess() )
    {
        ...
        $res = new TPPW_APIResult("ERR: 888, " . $data . "\r" . "\n");
