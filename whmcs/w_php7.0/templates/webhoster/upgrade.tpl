...
<p><input type="button" value="{$LANG.clientareabacklink}" onclick="window.location='clientarea.php?action=productdetails&id={$id}'" class="btn btn-success btn-sm" /></p>
...
<td class="text-center"><input type="submit" value="{$LANG.upgradedowngradechooseproduct}" class="btn btn-primary btn-sm" /></form></td>
</tr>
{/foreach}
</table>
</div>
...
<p><input type="submit" value="{$LANG.ordercontinuebutton}" class="btn btn-primary btn-sm" /></p>
