		...
		<div class="col-md-7 center-block">
			<form method="post" action="downloads.php?action=search">
				<div class="input-group">
					<input type="text" name="search" value="{if $search}{$search}{else}{$LANG.downloadssearch}{/if}" class="form-control input-lg" onfocus="if(this.value=='{$LANG.downloadssearch}')this.value=''" />
