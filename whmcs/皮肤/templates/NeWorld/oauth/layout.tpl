...
<html lang="en">
  <head>
    ...
    <link href="./templates/{$template}/css/all.min.css" rel="stylesheet">
    <link href="./templates/{$template}/css/custom.css" rel="stylesheet" >
    <link href="./templates/{$template}/oauth/css/style.css" rel="stylesheet">
  ...
  <body>
    ...
    <script src="./templates/{$template}/js/scripts.min.js"></script>
  </body>
</html>
